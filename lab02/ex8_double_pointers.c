...
Student* create_student_1(int id) {
  ...
  Student* student_ptr = malloc(sizeof(*student_ptr));
...
void create_student_2(Student** student_double_ptr, int id) {
  ...
  *student_double_ptr = malloc(sizeof(**student_double_ptr));
  (*student_double_ptr)->name = NULL;
